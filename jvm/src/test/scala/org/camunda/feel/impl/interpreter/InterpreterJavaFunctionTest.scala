...
/** @author Philipp Ossler
  */
class InterpreterJavaFunctionTest extends FlatSpec with Matchers with FeelIntegrationTest {
  ...
  it should "be invoked with one long parameters" in {
    ...
    val functions = Map(
      "abs" -> eval(""" function(a) external { java: { class: "java.lang.Math", method signature: "abs(long)" } } """)
        .asInstanceOf[ValFunction]
    )
